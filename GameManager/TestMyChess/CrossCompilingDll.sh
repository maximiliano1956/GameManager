...
i686-w64-mingw32-gcc -I../GameManager -shared -municode -DGAMEMANAGER_IMPORTS -DGAME_EXPORTS *.c ./nnue/*.cpp ../TestMyChess/GameManager.dll -o ../TestMyChess/MyChess.dll
cd ../TestMyChess
