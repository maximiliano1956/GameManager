...
PCLEANUP pCleanUp;
PISPOSOK pIsPosOk;
PEXTRADEPTH pExtraDepth;
PGETHASHKEY pGetHashKey;
PMAKENULLMOVE pMakeNullMove;
PTAKENULLMOVE pTakeNullMove;
PINITSEARCH pInitSearch;
PISDRAW pIsDraw;
PGETPLY pGetPly;
PGETSIDE pGetSide;
PCANDONULL pCanDoNull;
PGETBOOKMOVE pGetBookMove;
PSETHISTORY pSetHistory;
PSETKILLERS pSetKillers;
PPRINTMOVE pPrintMove;
PINITDLL pInitDll;
PGETPVSCORE pGetPvScore;
